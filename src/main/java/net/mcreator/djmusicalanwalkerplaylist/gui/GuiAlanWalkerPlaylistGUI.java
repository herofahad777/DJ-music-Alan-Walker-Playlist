...
public class GuiAlanWalkerPlaylistGUI extends ElementsDjMusicAlanWalkerPlaylistMod.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 10, this.guiTop + 32, 50, 20, "Faded"));
			this.buttonList.add(new GuiButton(1, this.guiLeft + 71, this.guiTop + 32, 65, 20, "Darkside"));
			this.buttonList.add(new GuiButton(2, this.guiLeft + 143, this.guiTop + 32, 80, 20, "The Spectre"));
			this.buttonList.add(new GuiButton(3, this.guiLeft + 230, this.guiTop + 32, 50, 20, "Alone"));
