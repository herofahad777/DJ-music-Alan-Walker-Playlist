...
public class ItemAlanWalkerDarkside extends ElementsDjMusicAlanWalkerPlaylistMod.ModElement {
	@GameRegistry.ObjectHolder("dj_music_alan_walker_playlist:alan_walker_darkside")
	public static final Item block = null;
	public ItemAlanWalkerDarkside(ElementsDjMusicAlanWalkerPlaylistMod instance) {
		super(instance, 6);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("dj_music_alan_walker_playlist:alan_walker_darkside", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("alan_walker_darkside", ElementsDjMusicAlanWalkerPlaylistMod.sounds
