...
public class ItemAlanWalkerPlaylist extends ElementsDjMusicAlanWalkerPlaylistMod.ModElement {
	@GameRegistry.ObjectHolder("dj_music_alan_walker_playlist:alan_walker_playlist")
	public static final Item block = null;
	public ItemAlanWalkerPlaylist(ElementsDjMusicAlanWalkerPlaylistMod instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("dj_music_alan_walker_playlist:alan_walker_playlist", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureRightclickonAlanWalkerPlaylist.executeProcedure($_dependencies);
			}
			return ar;
		}
