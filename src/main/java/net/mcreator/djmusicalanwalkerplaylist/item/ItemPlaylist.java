...
public class ItemPlaylist extends ElementsDjMusicAlanWalkerPlaylistMod.ModElement {
	@GameRegistry.ObjectHolder("dj_music_alan_walker_playlist:playlist")
	public static final Item block = null;
	public ItemPlaylist(ElementsDjMusicAlanWalkerPlaylistMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("dj_music_alan_walker_playlist:playlist", "inventory"));
	}
