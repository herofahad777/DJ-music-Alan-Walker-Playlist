...
package net.mcreator.djmusicalanwalkerplaylist.keybind;
...
public class KeyBindingJ extends ElementsDjMusicAlanWalkerPlaylistMod.ModElement {
	private KeyBinding keys;
	public KeyBindingJ(ElementsDjMusicAlanWalkerPlaylistMod instance) {
		super(instance, 41);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.j", Keyboard.KEY_J, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				DjMusicAlanWalkerPlaylistMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
